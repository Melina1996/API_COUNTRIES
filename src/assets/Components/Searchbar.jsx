...
export default function Searchbar() {
    ...
    function getInput(e){
        setInputValue(e.target.value.charAt(0).toUpperCase() + e.target.value.slice(1).toLowerCase())
    }
  ...
  return (
    <div className={`md:w-[50%] max-[426px]:w-[100%] flex md:justify-start max-[426px]:justify-center items-center py-3`}>
        ...
        <div className='relative xl:w-[400px] w-[300px]'>
            <input type="text" className={`shadow w-[100%] h-[50px] pl-14 rounded`} placeholder='Search for a country...' onChange={(e)=>getInput(e)}/>
